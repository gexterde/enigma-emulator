...
export class ModernThemeFactory extends ThemeFactory {
  public createTheme(): ThemeProduct {
    return {
      appBg: 'bg-white text-slate-900 selection:bg-blue-200',
      appTexture: '',
      ...
      radioChassisBg: 'bg-slate-100 border-slate-300 text-slate-900 shadow-md',
      radioRivets: 'bg-slate-300 border-slate-400',
      radioHeaderBorder: 'border-slate-300',
      radioPowerSwitchBg: 'bg-slate-200 border-slate-300',
      radioPowerOffText: 'text-red-600 font-bold',
      radioPowerOnText: 'text-blue-600 font-bold',
      radioPowerKnobBg: 'from-slate-200 via-slate-300 to-slate-400 border-slate-400',
      radioGlassDialBgOn: 'bg-white border-blue-300 shadow-inner',
      radioGlassDialBgOff: 'bg-slate-200 opacity-60',
      radioGlassDialBorder: 'border-blue-400/60',
      radioDialText: 'text-blue-700',
      radioDialTick: 'bg-blue-600',
      radioNeedle: 'bg-blue-600 shadow-md',
      radioNeedleGlow: 'rgba(37,99,235,0.8)',
      radioSMeterBg: 'bg-slate-50 border-slate-300',
      radioSMeterText: 'text-blue-700',
      radioSMeterNeedle: 'bg-blue-600',
      radioDisplayBoxBg: 'bg-slate-100 border-blue-400/60 shadow-sm',
      radioDisplayReadoutOn: 'text-blue-600 font-bold',
      radioDisplayReadoutOff: 'text-slate-400',
      radioDisplayTextAccent: 'text-blue-600',
      radioDisplayInputBg: 'bg-white border-blue-400/60 text-blue-700',
      radioStationBadge: 'bg-blue-100 text-blue-800 border-blue-300',
      radioRotaryModuleBg: 'bg-slate-100',
      radioRotaryModuleBorder: 'border-slate-300',
      radioRotaryKnobBg: 'from-slate-200 via-slate-100 to-slate-300',
      radioRotaryKnobBorder: 'border-slate-400',
      radioRotaryKnobNotch: 'bg-blue-600 shadow-sm',
      radioRotaryCap: 'from-blue-200 via-slate-200 to-blue-300 border-blue-400',
      radioSpeedBtnActive: 'bg-blue-600 text-white border-blue-600 shadow-sm',
      radioSpeedBtnInactive: 'text-slate-600 hover:text-slate-900',
      radioPresetBtnActive: 'bg-blue-600 text-white border-blue-600 shadow-sm',
      radioPresetBtnInactive: 'bg-white border-slate-300 text-slate-700 hover:border-blue-400 hover:bg-slate-50',
      radioScopeBg: '#f8fafc',
      radioScopeGrid: 'rgba(148, 163, 184, 0.4)',
      radioScopeWaveActive: '#2563eb',
      radioScopeWaveIdle: '#cbd5e1',
    };
  }
}
