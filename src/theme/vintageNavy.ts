...
export class VintageNavyThemeFactory extends ThemeFactory {
  public createTheme(): ThemeProduct {
    return {
      ...
      radioChassisBg: 'bg-[#081226]/95 border-[#1b2a4a] text-[#dce4f7]',
      radioRivets: 'bg-[#1d2d52] border-[#2d4273]',
      radioHeaderBorder: 'border-[#1d2d52]',
      radioPowerSwitchBg: 'bg-[#040a17]/90 border-[#1d2d52]',
      radioPowerOffText: 'text-rose-400 drop-shadow-[0_0_6px_rgba(244,63,94,0.8)]',
      radioPowerOnText: 'text-cyan-400 drop-shadow-[0_0_6px_rgba(34,211,238,0.8)]',
      radioPowerKnobBg: 'from-[#0f1b38] via-[#081126] to-[#030712] border-[#293d6b]',
      radioGlassDialBgOn: 'bg-gradient-to-b from-[#091e42] via-[#040a17] to-[#091e42] shadow-[0_0_20px_rgba(34,211,238,0.25)]',
      radioGlassDialBgOff: 'bg-[#040a17] opacity-60',
      radioGlassDialBorder: 'border-[#22d3ee]/50',
      radioDialText: 'text-cyan-300',
      radioDialTick: 'bg-cyan-400/70',
      radioNeedle: 'bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.9)]',
      radioNeedleGlow: 'rgba(251,191,36,0.8)',
      radioSMeterBg: 'bg-[#0c1f40] border-[#1d3d73]',
      radioSMeterText: 'text-cyan-200',
      radioSMeterNeedle: 'bg-amber-400',
      radioDisplayBoxBg: 'bg-[#040a17] border-[#22d3ee]/60 shadow-[0_0_15px_rgba(34,211,238,0.2)]',
      radioDisplayReadoutOn: 'text-cyan-300 drop-shadow-[0_0_12px_rgba(34,211,238,0.8)]',
      radioDisplayReadoutOff: 'text-slate-800',
      radioDisplayTextAccent: 'text-cyan-200',
      radioDisplayInputBg: 'bg-[#081226] border-[#22d3ee]/60 text-cyan-300',
      radioStationBadge: 'bg-[#0e2752] text-cyan-300 border-[#22d3ee]/60',
      radioRotaryModuleBg: 'bg-[#040a17]/90',
      radioRotaryModuleBorder: 'border-[#1d2d52]',
      radioRotaryKnobBg: 'from-[#0f1d3d] via-[#081126] to-black',
      radioRotaryKnobBorder: 'border-[#253966]',
      radioRotaryKnobNotch: 'bg-cyan-400 shadow-[0_0_8px_rgba(34,211,238,0.9)]',
      radioRotaryCap: 'from-[#1a366b] via-[#0d1e3d] to-[#1a366b] border-[#22d3ee]/60',
      radioSpeedBtnActive: 'bg-[#0e2752] text-cyan-300 border border-[#22d3ee]/80 shadow-sm',
      radioSpeedBtnInactive: 'text-slate-400 hover:text-slate-200',
      radioPresetBtnActive: 'bg-[#0e2752] text-cyan-300 border-[#22d3ee] shadow-md shadow-[#0a1e42]/60',
      radioPresetBtnInactive: 'bg-[#081226] border-[#1d2d52] text-slate-300 hover:border-[#22d3ee]/60',
      radioScopeBg: '#040a17',
      radioScopeGrid: 'rgba(34, 211, 238, 0.15)',
      radioScopeWaveActive: '#22d3ee',
      radioScopeWaveIdle: '#1e3a8a',
    };
  }
}
