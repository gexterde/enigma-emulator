...
export class ModernDarkThemeFactory extends ThemeFactory {
  public createTheme(): ThemeProduct {
    return {
      ...
      radioChassisBg: 'bg-zinc-900/95 border-zinc-800 text-zinc-100',
      radioRivets: 'bg-zinc-700 border-zinc-600',
      radioHeaderBorder: 'border-zinc-800',
      radioPowerSwitchBg: 'bg-zinc-950/90 border-zinc-800',
      ...
      radioPowerKnobBg: 'from-zinc-800 via-zinc-900 to-black border-zinc-700',
      radioGlassDialBgOn: 'bg-gradient-to-b from-zinc-950 via-zinc-900 to-zinc-950 shadow-[0_0_20px_rgba(16,185,129,0.25)]',
      radioGlassDialBgOff: 'bg-zinc-950 opacity-60',
      radioGlassDialBorder: 'border-emerald-500/50',
      radioDialText: 'text-emerald-300',
      radioDialTick: 'bg-emerald-400/70',
      radioNeedle: 'bg-rose-500 shadow-[0_0_8px_rgba(244,63,94,0.9)]',
      radioNeedleGlow: 'rgba(244,63,94,0.8)',
      radioSMeterBg: 'bg-zinc-950 border-zinc-800',
      radioSMeterText: 'text-emerald-300',
      radioSMeterNeedle: 'bg-rose-500',
      radioDisplayBoxBg: 'bg-zinc-950 border-emerald-500/60 shadow-[0_0_15px_rgba(16,185,129,0.2)]',
      radioDisplayReadoutOn: 'text-emerald-400 drop-shadow-[0_0_12px_rgba(52,211,153,0.8)]',
      radioDisplayReadoutOff: 'text-zinc-800',
      radioDisplayTextAccent: 'text-emerald-300',
      radioDisplayInputBg: 'bg-zinc-900 border-emerald-500/60 text-emerald-300',
      radioStationBadge: 'bg-emerald-950 text-emerald-300 border-emerald-600',
      radioRotaryModuleBg: 'bg-zinc-950/90',
      radioRotaryModuleBorder: 'border-zinc-800',
      radioRotaryKnobBg: 'from-zinc-800 via-zinc-900 to-black',
      radioRotaryKnobBorder: 'border-zinc-700',
      radioRotaryKnobNotch: 'bg-emerald-400 shadow-[0_0_8px_rgba(52,211,153,0.9)]',
      radioRotaryCap: 'from-emerald-950 via-zinc-800 to-emerald-950 border-emerald-600',
      radioSpeedBtnActive: 'bg-emerald-950 text-emerald-300 border border-emerald-600 shadow-sm',
      radioSpeedBtnInactive: 'text-zinc-400 hover:text-zinc-200',
      radioPresetBtnActive: 'bg-emerald-950 text-emerald-300 border-emerald-500 shadow-md shadow-emerald-950/50',
      radioPresetBtnInactive: 'bg-zinc-900 border-zinc-800 text-zinc-300 hover:border-emerald-500/60',
      radioScopeBg: '#09090b',
      radioScopeGrid: 'rgba(16, 185, 129, 0.15)',
