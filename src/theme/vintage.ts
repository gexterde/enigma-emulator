...
export class VintageThemeFactory extends ThemeFactory {
  public createTheme(): ThemeProduct {
    return {
      ...
      radioChassisBg: 'bg-stone-900/90 border-stone-800 text-stone-200',
      radioRivets: 'bg-stone-700 border-stone-600',
      radioHeaderBorder: 'border-stone-700',
      radioPowerSwitchBg: 'bg-stone-950/80 border-stone-800',
      ...
      radioPowerKnobBg: 'from-stone-800 via-stone-900 to-stone-950 border-stone-600',
      radioGlassDialBgOn: 'bg-gradient-to-b from-amber-950/90 via-stone-950 to-amber-950/90 shadow-[0_0_20px_rgba(245,158,11,0.25)]',
      radioGlassDialBgOff: 'bg-stone-950 opacity-60',
      radioGlassDialBorder: 'border-amber-800/60',
      radioDialText: 'text-amber-400/90',
      radioDialTick: 'bg-amber-500/70',
      radioNeedle: 'bg-red-500 shadow-[0_0_8px_rgba(239,68,68,0.9)]',
      radioNeedleGlow: 'rgba(239,68,68,0.8)',
      radioSMeterBg: 'bg-amber-950/40 border-amber-900/60',
      radioSMeterText: 'text-amber-300',
      radioSMeterNeedle: 'bg-red-500',
      radioDisplayBoxBg: 'bg-stone-950 border-amber-800/80 shadow-[0_0_15px_rgba(245,158,11,0.2)]',
      radioDisplayReadoutOn: 'text-amber-400 drop-shadow-[0_0_12px_rgba(251,191,36,0.8)]',
      radioDisplayReadoutOff: 'text-stone-700',
      radioDisplayTextAccent: 'text-amber-300',
      radioDisplayInputBg: 'bg-stone-900 border-amber-800 text-amber-300',
      radioStationBadge: 'bg-amber-950/80 text-amber-300 border-amber-700/80',
      radioRotaryModuleBg: 'bg-stone-950/80',
      radioRotaryModuleBorder: 'border-stone-800',
      radioRotaryKnobBg: 'from-stone-800 via-stone-900 to-black',
      radioRotaryKnobBorder: 'border-stone-700',
      radioRotaryKnobNotch: 'bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.9)]',
      radioRotaryCap: 'from-amber-900 via-stone-700 to-amber-700 border-amber-600/80',
      radioSpeedBtnActive: 'bg-amber-950 text-amber-300 border border-amber-600 shadow-sm',
      radioSpeedBtnInactive: 'text-stone-400 hover:text-stone-200',
      radioPresetBtnActive: 'bg-amber-950 text-amber-300 border-amber-500 shadow-md shadow-amber-950/40',
      radioPresetBtnInactive: 'bg-stone-900 border-stone-800 text-stone-300 hover:border-amber-600/60',
      radioScopeBg: '#090d16',
      radioScopeGrid: 'rgba(245, 158, 11, 0.15)',
      radioScopeWaveActive: '#f59e0b',
      radioScopeWaveIdle: '#451a03',
    };
  }
}
