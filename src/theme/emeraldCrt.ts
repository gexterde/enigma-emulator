...
export class EmeraldCrtThemeFactory extends ThemeFactory {
  public createTheme(): ThemeProduct {
    return {
      ...
      radioChassisBg: 'bg-[#00120a]/95 border-[#003a20] text-emerald-100',
      radioRivets: 'bg-[#002a17] border-[#004a2b]',
      radioHeaderBorder: 'border-[#003a20]',
      radioPowerSwitchBg: 'bg-[#000804]/90 border-[#003a20]',
      radioPowerOffText: 'text-rose-500 drop-shadow-[0_0_6px_rgba(244,63,94,0.8)]',
      radioPowerOnText: 'text-emerald-400 drop-shadow-[0_0_6px_rgba(52,211,153,0.8)]',
      radioPowerKnobBg: 'from-[#002a17] via-[#00120a] to-black border-[#004a2b]',
      radioGlassDialBgOn: 'bg-gradient-to-b from-[#002a17] via-[#000804] to-[#002a17] shadow-[0_0_20px_rgba(16,185,129,0.35)]',
      radioGlassDialBgOff: 'bg-[#000804] opacity-60',
      radioGlassDialBorder: 'border-emerald-500/60',
      radioDialText: 'text-emerald-400',
      radioDialTick: 'bg-emerald-400',
      radioNeedle: 'bg-emerald-300 shadow-[0_0_10px_rgba(52,211,153,1)]',
      radioNeedleGlow: 'rgba(52,211,153,0.9)',
      radioSMeterBg: 'bg-[#000804] border-[#003a20]',
      radioSMeterText: 'text-emerald-400',
      radioSMeterNeedle: 'bg-emerald-400',
      radioDisplayBoxBg: 'bg-[#000804] border-emerald-500/80 shadow-[0_0_15px_rgba(16,185,129,0.3)]',
      radioDisplayReadoutOn: 'text-emerald-400 drop-shadow-[0_0_14px_rgba(52,211,153,0.9)]',
      radioDisplayReadoutOff: 'text-emerald-950',
      radioDisplayTextAccent: 'text-emerald-300',
      radioDisplayInputBg: 'bg-[#00120a] border-emerald-600 text-emerald-300',
      radioStationBadge: 'bg-emerald-950 text-emerald-300 border-emerald-600',
      radioRotaryModuleBg: 'bg-[#000804]/90',
      radioRotaryModuleBorder: 'border-[#003a20]',
      radioRotaryKnobBg: 'from-[#002a17] via-[#00120a] to-black',
      radioRotaryKnobBorder: 'border-[#004a2b]',
      radioRotaryKnobNotch: 'bg-emerald-300 shadow-[0_0_10px_rgba(52,211,153,1)]',
      radioRotaryCap: 'from-emerald-950 via-[#002a17] to-emerald-950 border-emerald-600',
      radioSpeedBtnActive: 'bg-emerald-950 text-emerald-300 border border-emerald-600 shadow-sm',
      radioSpeedBtnInactive: 'text-emerald-600 hover:text-emerald-300',
      radioPresetBtnActive: 'bg-emerald-950 text-emerald-300 border-emerald-500 shadow-md shadow-emerald-950/60',
      radioPresetBtnInactive: 'bg-[#00120a] border-[#003a20] text-emerald-400/80 hover:border-emerald-500/60',
      radioScopeBg: '#000804',
      radioScopeGrid: 'rgba(16, 185, 129, 0.2)',
      radioScopeWaveActive: '#10b981',
      radioScopeWaveIdle: '#064e3b',
    };
  }
}
