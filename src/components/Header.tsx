  ...
  return (
    <header className={`${t.modalHeaderBg} shadow-md flex justify-between items-center w-full px-4 md:px-8 h-16 shrink-0 z-50`}>
      ...
      <div className="flex items-center gap-1 md:gap-2">
        {user ? (
          <div className={`flex items-center ${t.panelInner} rounded-lg px-2 md:px-2.5 h-8 border ${t.borderBase} mr-1 md:mr-1.5 shadow-inner`}>
            ...
            <div className={`w-px h-4 ${t.borderBase} mx-1.5 md:mx-2`}></div>
            <button
