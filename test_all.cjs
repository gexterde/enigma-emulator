      ...
      for (let r2 of allRotors) {
        for (let r3 of allRotors) {
          ...
          try {
            ...
            if (decrypted.includes("HELLO") || decrypted.includes("GEHEIM") || decrypted.includes("WETTER") || decrypted.includes("KRIEG") || decrypted.includes("GUTEN") || decrypted.includes("MORGEN")) {
